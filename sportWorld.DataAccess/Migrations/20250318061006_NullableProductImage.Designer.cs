...
namespace sportWorld.DataAccess.Migrations
{
    ...
    [Migration("20250318061006_NullableProductImage")]
    partial class NullableProductImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sportWorld.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("sportWorld.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("sportWorld.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("sportWorld.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("sportWorld.Models.OrderDetail", b =>
                {
                    b.HasOne("sportWorld.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("sportWorld.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("sportWorld.Models.OrderHeader", b =>
                {
                    b.HasOne("sportWorld.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("sportWorld.Models.ApplicationUser", b =>
                {
                    b.HasOne("sportWorld.Models.Company", "Company")
                        .WithMany()
